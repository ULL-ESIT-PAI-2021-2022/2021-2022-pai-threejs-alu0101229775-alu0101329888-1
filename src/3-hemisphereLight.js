...
function main() {
  ...
  // Cube
  const CUBE_MEDIUM_GEOMETRY = new THREE.BoxGeometry(1, 1, 1);                  // Cube with dimensions 1x1x1
  const CUBE_MEDIUM_MATERIAL = new THREE.MeshStandardMaterial({                 // White standard material for the cube
